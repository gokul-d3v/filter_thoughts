...
export default function PrivatePage() {
  return (
    ...
    >
      ...
      <h1 className="font-headline-lg text-headline-lg text-primary mb-4 tracking-tight">Private Network</h1>
      <p className="font-body-md text-on-surface-variant max-w-md mx-auto leading-relaxed">
        Access to hidden network nodes and dark rooms requires an invitation link or strict cryptographic credentials.
      </p>
    </motion.div>
  );
}
